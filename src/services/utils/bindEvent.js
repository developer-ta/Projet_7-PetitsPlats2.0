...
const searchValOnClick = (option) => {
  ...
  element.addEventListener('click', ev => {
    ...
    if (ev.target.tagName == 'SPAN') { searchVal = ev.target.parentElement.firstElementChild.value } else if (ev.target.tagName == 'I') { searchVal = ev.target.parentElement.parentElement.firstElementChild.value }
