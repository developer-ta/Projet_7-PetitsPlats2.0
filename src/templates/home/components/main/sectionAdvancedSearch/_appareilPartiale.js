export const appareilsDisplay = (data) => {
	...
	let textContents = applianceList.map(el => el.textContent.toLowerCase())
	let uniqueElements = applianceList.filter((el, i) => i == textContents.indexOf(el.textContent.toLowerCase()))
